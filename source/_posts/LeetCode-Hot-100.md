...
## 使用方式（Android / Java / 现场手撕）
- 计时：Medium 25min / Hard 45min；超时先看思路，再关掉题解重写一遍
...
每天固定三件事：
1) 新题 4 题（限时写完；不会就看思路后关掉题解重写）
2) 复盘 1 题（闭卷重写）：优先选昨天做错/卡住的题；没错题就复写昨天最耗时的题
3) 工程型手撕（隔天 1 次，30-45min）：按 Day 2/4/6/8/10/12/14 做 1 个（见下方附录）

新题安排（14 天）：
- Day 1（哈希/前缀和）：[1 两数之和](#lc1)、[49 字母异位词分组](#lc49)、[128 最长连续序列](#lc128)、[560 和为 K 的子数组](#lc560)
- Day 2（滑动窗口/双指针）：[3 无重复字符的最长子串](#lc3)、[76 最小覆盖子串](#lc76)、[438 找到字符串中所有字母异位词](#lc438)、[11 盛最多水的容器](#lc11)
- Day 3（数组/双指针）：[15 三数之和](#lc15)、[75 颜色分类](#lc75)、[283 移动零](#lc283)、[287 寻找重复数](#lc287)
- Day 4（栈/单调）：[20 有效的括号](#lc20)、[739 每日温度](#lc739)、[394 字符串解码](#lc394)、[42 接雨水](#lc42)
- Day 5（二分/矩阵/前缀）：[33 搜索旋转排序数组](#lc33)、[34 在排序数组中查找元素的第一个和最后一个位置](#lc34)、[240 搜索二维矩阵 II](#lc240)、[238 除了自身以外数组的乘积](#lc238)
- Day 6（区间/堆）：[56 合并区间](#lc56)、[215 数组中的第K个最大元素](#lc215)、[253 会议室 II](#lc253)、[347 前 K 个高频元素](#lc347)
- Day 7（链表基础）：[19 删除链表的倒数第 N 个结点](#lc19)、[21 合并两个有序链表](#lc21)、[141 环形链表](#lc141)、[206 反转链表](#lc206)
- Day 8（树基础）：[102 二叉树的层序遍历](#lc102)、[104 二叉树的最大深度](#lc104)、[101 对称二叉树](#lc101)、[226 翻转二叉树](#lc226)
- Day 9（树进阶/树DP）：[105 从前序与中序遍历序列构造二叉树](#lc105)、[236 二叉树的最近公共祖先](#lc236)、[337 打家劫舍 III](#lc337)、[543 二叉树的直径](#lc543)
- Day 10（DP 核心）：[70 爬楼梯](#lc70)、[198 打家劫舍](#lc198)、[322 零钱兑换](#lc322)、[300 最长递增子序列](#lc300)
- Day 11（DP/字符串）：[53 最大子数组和](#lc53)、[121 买卖股票的最佳时机](#lc121)、[309 买卖股票的最佳时机含冷冻期](#lc309)、[139 单词拆分](#lc139)
- Day 12（回溯基础）：[17 电话号码的字母组合](#lc17)、[22 括号生成](#lc22)、[39 组合总和](#lc39)、[46 全排列](#lc46)
- Day 13（回溯 + 难点）：[78 子集](#lc78)、[79 单词搜索](#lc79)、[239 滑动窗口最大值](#lc239)、[5 最长回文子串](#lc5)
- Day 14（设计 + 图）：[146 LRU 缓存](#lc146)、[208 实现 Trie (前缀树)](#lc208)、[200 岛屿数量](#lc200)、[207 课程表](#lc207)

工程型手撕安排（隔天 1 个，30-45min）：
- Day 2：LRU Cache
- Day 4：阻塞队列：生产者-消费者
- Day 6：重试器：指数退避 + 最大次数 + 可取消
- Day 8：限流器：Token Bucket
- Day 10：带超时的缓存：LRU + TTL
- Day 12：Debounce/Throttle
- Day 14：线程安全单例：双检锁

## 附录：工程型手撕（Java / Android 常见）

面试现场经常会从业务/工程抽象出“写个类/写个工具”。建议你至少能在白板/纸上写出核心版本，并解释线程安全和复杂度。
